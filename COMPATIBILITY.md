...
| **v1.3.0 – v1.5.0**（当前） | **0.1.5-rc.1 – 0.1.5-rc.2**（0.1.5-rc 线） | ✅ 在 rc.2 上实测（typecheck 0 错 + build + 测试 1156/1165） | `dsh-palm` | **否** — 升级后需重新扫码配对一次 | 与 dsh-remote-web-ui / dsh-webui 命名与依赖解耦 |
